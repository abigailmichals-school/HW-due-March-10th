let nounArray = ["Computer", "flower", "cat", "cruise ship", "gloves", "toy", "Donut", "table"]
let nounCounter = 0

let adjectiveArray = ["pretty", "second-hand", "flowery", "whispering", "pastoral", "quaint", "relevant", "boring"]
